...
"""Setup script for packaging openpyxlzip.
...
spec = spec_from_file_location("constants", "./openpyxlzip/_constants.py")
...
def cythonize_modules():
    ...
    return cythonize([
        "openpyxlzip/worksheet/_reader.py",
        "openpyxlzip/worksheet/_writer.py",
        "openpyxlzip/utils/cell.py",
        ],
        nthreads=3,
        language_level=3,
    )
