...
from openpyxlzip.chart import BarChart, Reference
from openpyxlzip.chart.marker import DataPoint

from openpyxlzip.drawing.fill import PatternFillProperties, ColorChoice
