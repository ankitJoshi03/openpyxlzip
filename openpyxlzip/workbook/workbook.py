...
from openpyxlzip.worksheet.worksheet import Worksheet
from openpyxlzip.worksheet._read_only import ReadOnlyWorksheet
from openpyxlzip.worksheet._write_only import WriteOnlyWorksheet
from openpyxlzip.worksheet.copier import WorksheetCopy

from openpyxlzip.utils import quote_sheetname
from openpyxlzip.utils.indexed_list import IndexedList
from openpyxlzip.utils.datetime  import CALENDAR_WINDOWS_1900
from openpyxlzip.utils.exceptions import ReadOnlyWorkbookException

from openpyxlzip.writer.excel import save_workbook

from openpyxlzip.styles.cell_style import StyleArray
from openpyxlzip.styles.named_styles import NamedStyle
from openpyxlzip.styles.differential import DifferentialStyleList
from openpyxlzip.styles.alignment import Alignment
from openpyxlzip.styles.borders import DEFAULT_BORDER
from openpyxlzip.styles.fills import DEFAULT_EMPTY_FILL, DEFAULT_GRAY_FILL
from openpyxlzip.styles.fonts import DEFAULT_FONT
from openpyxlzip.styles.protection import Protection
from openpyxlzip.styles.colors import COLOR_INDEX
from openpyxlzip.styles.named_styles import NamedStyleList
from openpyxlzip.styles.table import TableStyleList
...
from openpyxlzip.packaging.relationship import RelationshipList
...
class Workbook(object):
    ...
    def __init__(self,
        ...
        self._printer_settings = None #MattJ added
        self._custom_xml = None #MattJ added
        self.package = None #MattJ added
        self._all_drawings = None #MattJ added
        self.drawings = None
        self._all_drawings_rels = None #MattJ added
        self._all_drawing_dependencies = None #MattJ added
        self._nsmaps = None
        ...
        self.app_archive = None
        self.arc_custom = None
    ...
    def active(self):
        ...
        :type: :class:`openpyxlzip.worksheet.worksheet.Worksheet`
        """
        try:
    ...
    def worksheets(self):
        ...
        :type: list of :class:`openpyxlzip.worksheet.worksheet.Worksheet`
        """
    ...
    def chartsheets(self):
        ...
        :type: list of :class:`openpyxlzip.chartsheet.chartsheet.Chartsheet`
        """
    ...
    def mime_type(self):
        ...
        extension to match but openpyxlzip does not enforce this.
    ...
    def save(self, filename):
        ...
        .. warning::
            ...
            modify or save the file will raise an :class:`openpyxlzip.shared.exc.WorkbookAlreadySaved` exception.
        """
        if self.read_only:
    ...
    def set_checkboxes(self, checkbox_values):
        """
