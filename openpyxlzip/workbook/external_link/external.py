...
from openpyxlzip.descriptors.excel import Relation, ExtensionList
from openpyxlzip.descriptors.nested import NestedText
from openpyxlzip.descriptors.sequence import NestedSequence, ValueSequence
...
class ExternalLink(Serialisable):
    ...
    def to_tree(self, elem_type=None):
        node = super(ExternalLink, self).to_tree(elem_type=elem_type)
