...
from openpyxlzip.xml.constants import DRAWING_NS, DRAWING_14_NS, DRAWING_16_NS
...
class NonVisualGroupDrawingShapeProps(Serialisable):
    ...
    __elements__ = ("grpSpLocks", 'extLst',)
...
class NonVisualDrawingShapeProps(Serialisable):
    ...
    __elements__ = ("spLocks", "txBox", 'extLst',)
...
class NonVisualDrawingProps(Serialisable):
    ...
    __elements__ = ["hlinkClick", "hlinkHover", 'extLst',]
