...
from openpyxlzip.descriptors.excel import (
    HexBinary,
    TextPoint,
    Coordinate,
    ExtensionList,
...
from openpyxlzip.xml.constants import DRAWING_NS
...
from openpyxlzip.descriptors.nested import NestedBool
...
class ParagraphProperties(Serialisable):
    ...
    __elements__ = ('lnSpc', 'spcBef', 'spcAft', 'tabLst', 'defRPr',
                    ...
                    'buNone', 'buAutoNum', 'buChar', 'buBlip', 'extLst',)
...
class ListStyle(Serialisable):
    ...
    __elements__ = ("defPPr", "lvl1pPr", "lvl2pPr", "lvl3pPr", "lvl4pPr",
                    "lvl5pPr", "lvl6pPr", "lvl7pPr", "lvl8pPr", "lvl9pPr", 'extLst',)
...
class RichTextProperties(Serialisable):
    ...
    __elements__ = ('prstTxWarp', 'scene3d', 'noAutofit', 'normAutofit', 'spAutoFit', 'extLst',)
