...
from openpyxlzip.xml.functions import NS_REGEX, Element
from openpyxlzip.xml.constants import CHART_NS, REL_NS, DRAWING_NS
...
from openpyxlzip.chart.text import RichText
