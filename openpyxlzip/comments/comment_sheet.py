...
from openpyxlzip.descriptors.excel import Guid, ExtensionList
...
#from openpyxlzip.worksheet.ole import ObjectAnchor
...
class CommentSheet(Serialisable):
    ...
    def to_tree(self, elem_type=None):
        tree = super(CommentSheet, self).to_tree(elem_type=elem_type)
