# Copyright (c) openpyxlzip 2010-2020
...
from openpyxlzip.styles.colors import Color, ColorDescriptor
from openpyxlzip.styles.differential import DifferentialStyle

from openpyxlzip.utils.cell import COORD_RE
...
class Rule(Serialisable):
    ...
    __elements__ = ('colorScale', 'dataBar', 'iconSet', 'formula', 'extLst',)
