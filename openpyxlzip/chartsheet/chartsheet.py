...
from openpyxlzip.descriptors import Typed, Set, Alias
from openpyxlzip.descriptors.excel import ExtensionList
from openpyxlzip.descriptors.serialisable import Serialisable
from openpyxlzip.drawing.spreadsheet_drawing import (
    AbsoluteAnchor,
    SpreadsheetDrawing,
)
from openpyxlzip.worksheet.page import (
    PageMargins,
    PrintPageSetup
)
from openpyxlzip.packaging.relationship import Relationship, RelationshipList
from openpyxlzip.worksheet.drawing import Drawing
from openpyxlzip.worksheet.header_footer import HeaderFooter
...
class Chartsheet(_WorkbookChild, Serialisable):
    ...
    def to_tree(self, elem_type=None):
        ...
        tree = super(Chartsheet, self).to_tree(elem_type=elem_type)
