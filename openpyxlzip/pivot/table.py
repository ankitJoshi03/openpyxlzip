...
from openpyxlzip.descriptors.nested import NestedInteger
...
from openpyxlzip.worksheet.filters import (
    AutoFilter,
    CellRange,
    ColorFilter,
    CustomFilter,
...
class TableDefinition(Serialisable):
    ...
    def to_tree(self, elem_type=None):
        root_tag = "{http://schemas.microsoft.com/office/spreadsheetml/2009/9/main}pivotTableDefinition"
    ...
    def _write_rels(self, archive, manifest):
        ...
        if LXML:
            xml = tostring(rels.to_tree(), pretty_print = True, xml_declaration = True, encoding='UTF-8', standalone=True)
        else:
