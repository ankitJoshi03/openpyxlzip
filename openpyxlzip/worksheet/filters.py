...
from openpyxlzip.descriptors.sequence import ValueSequence
...
class SortState(Serialisable):
    ...
    __elements__ = ('sortCondition', 'extLst',)
...
class AutoFilter(Serialisable):
    ...
    __elements__ = ('filterColumn', 'sortState', 'extLst',)
