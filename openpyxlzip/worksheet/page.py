...
from openpyxlzip.descriptors.excel import UniversalMeasure, Relation
from openpyxlzip.xml.constants import REL_NS
...
class PrintPageSetup(Serialisable):
    ...
    def from_tree(cls, node):
        ...
        # self.id = None # Preserve print settings id
        return self
