...
from openpyxlzip.utils.datetime  import CALENDAR_WINDOWS_1900, CALENDAR_MAC_1904
from openpyxlzip.styles.styleable import StyleArray
...
class TestWorksheetReader:
    ...
    def test_merged_hyperlinks(self, PrimedWorksheetReader):
        ...
        assert ws["G23"].hyperlink.tooltip == "openpyxlzip"
