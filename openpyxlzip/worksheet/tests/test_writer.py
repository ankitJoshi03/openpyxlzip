...
from openpyxlzip.worksheet.datavalidation import DataValidation
from openpyxlzip.workbook import Workbook
from openpyxlzip.styles import PatternFill, Font, Color
from openpyxlzip.formatting.rule import CellIsRule
...
class TestWorksheetWriter:
    ...
    def test_hyperlinks(self, writer):
        ...
        <worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
        <hyperlinks>
          <hyperlink xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" r:id="rId1" ref="A1"/>
        </hyperlinks>
        </worksheet>
        """
        diff = compare_xml(xml, expected)
    ...
    def test_breaks(self, writer):
        ...
        writer.write_row_breaks()
        writer.write_col_breaks()
        xml = writer.read()
        expected = """
        <worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
