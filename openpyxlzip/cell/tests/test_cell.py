...
from openpyxlzip.cell.cell import ERROR_CODES
...
def DummyWorksheet():
    ...
    from openpyxlzip.cell import Cell
...
def test_illegal_characters(dummy_cell):
    from openpyxlzip.utils.exceptions import IllegalCharacterError
...
def test_fill(DummyWorksheet, Cell):
    from openpyxlzip.styles import PatternFill
...
def test_border(DummyWorksheet, Cell):
    from openpyxlzip.styles import Border
    border = Border()
    ws = DummyWorksheet
...
def test_alignment(DummyWorksheet, Cell):
    from openpyxlzip.styles import Alignment
...
def test_protection(DummyWorksheet, Cell):
    from openpyxlzip.styles import Protection
