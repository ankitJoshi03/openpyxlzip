...
from openpyxlzip.packaging.workbook import WorkbookPackage
from openpyxlzip.workbook import Workbook
from openpyxlzip.workbook.defined_name import (
    _unpack_print_area,
    _unpack_print_titles,
)
from openpyxlzip.workbook.external_link.external import read_external_link
from openpyxlzip.pivot.cache import CacheDefinition
from openpyxlzip.pivot.record import RecordList
...
class WorkbookParser:
    ...
    def parse(self):
        ...
        self.wb.package = package
        self.wb.code_name = package.properties.codeName
        self.wb.defaultThemeVersion = package.properties.defaultThemeVersion
        self.wb.fileVersion = package.fileVersion
        ...
        self.wb.extra_elem = package.extra_elem
