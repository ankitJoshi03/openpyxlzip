...
from openpyxlzip.xml.functions import Element, localname
...
class PatternFill(Fill):
    ...
    def to_tree(self, tagname=None, idx=None, elem_type=None):
        parent = Element("fill")
...
class GradientFill(Fill):
    ...
    def to_tree(self, tagname=None, namespace=None, idx=None, elem_type=None):
        parent = Element("fill")
